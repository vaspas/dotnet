...
namespace IncModules.Ink824
{
    ...
    public sealed unsafe class AdcThread
    {
        ...
        /// </summary>
        /// <exception cref="INC824Exception">если поток не остановлен</exception>
        ...
        /// <summary>
        /// Возвращает ссылку на объект для синхронизации вызовов функций библиотеки с потоком сбора.
        /// </summary>
        ...
        /// </summary>
        /// <param name="startMode">Режим запуска.</param>
        ...
        public int Run(StartMode startMode)
        {
            ...
            //запускаем в зависимости от типа запуска
            var res = (int)RunSborErrors.Failed;            
            switch (startMode)
            {
                case StartMode.Internal:    //безусловный
                    ...
                    break;
                case StartMode.External:    //внешний
                    ...
                    break;
                case StartMode.Time:        //по времени
                    ...
                    break;
                default:
                    System.Diagnostics.Debug.Assert(false, "Необработанное значение типа запуска!!!");
                    break;
            }
