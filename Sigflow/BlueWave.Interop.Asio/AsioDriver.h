	...
	namespace Interop
	{
		namespace Asio
		{
				...
				public:
					...
					property int					BufferSizeInput			{ int get(); }
					property int					BufferSizeOutput		{ int get(); }
					...
					void CreateInputBuffers(int bufferSize);
					void CreateOutputBuffers(int bufferSize);
					void DisposeBuffers();
					void Release();
