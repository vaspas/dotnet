...
namespace TalkModules
{
    ...
    /// </remarks>
    public class Anal13WriterModule : IExecuteModule
    {
        public Anal13WriterModule()
        {
        ...
        public bool? Execute()
        {
            ...
            var packet = PacketFactory.Create<Anal13Packet>();
            ...
            packet.FirstFrequency = FirstFrequency;
