...
{
    class GdiPlusBufferedGraphics : Form, ITestWindow
    {
        public GdiPlusBufferedGraphics()
        {
        ...
        private readonly ControlTapeBufferedModel _model = new ControlTapeBufferedModel();
