...
namespace TapeDrawingSharpDx
{
	...
	public class GraphicContext : IGraphicContext,IDisposable
	{
	    ...
	    private void CreateCacheObjects()
		{
            ...
            _lineCacher = new LineFromArgsCreator { Device = Graphics.Device};
		    ...
		    _fontCacher = new FontFromGdiCreator {Device = Graphics.Device};
		...
		/// Кэш шрифтов
		/// </summary>
        private ICacher<SharpDX.Direct3D9.Font, System.Drawing.Font> _fontCacher;
		/// <summary>
		/// Кэш текстур
		/// </summary>
